...
<?php
  ...
  setcookie("page", '' ,'',"/");
  //номер вопроса - $x
 if (isset($_COOKIE['reiting']) && $_COOKIE['reiting']!=5 && $_COOKIE['reiting']!=10 && 15) {
      setcookie("reiting", '' ,'',"/");
 }  
?>     
      ...
      <div class="col-md-6 col-xl-4 a2 justify-content-center">
        <div id="rectangle4">
          <p style = "text-align: center; <?php if (($x == 5)||($x == 10)||($x==15)){echo ('color: #007bff');} else {echo ('color: #6be186');} ?>">Вы проиграли!
          </p>
          <p style = "text-align: center;">Заработанные ProgramCoin ($PC): <?php if (isset($_COOKIE['reiting'])){echo $_COOKIE['reiting'];} else {echo 'все сгорели';} ?></p>
        </div>
      </div>

<?php setcookie("reiting", '' ,'',"/"); ?>
      ...
      <div class="col-md-6 col-xl-3 b2">
        <div class="container-fluid">
          <div>
            ...
            <button id="1" type="button" class="btn btn-outline-dark mb-4 mr-4 mi1" style ="text-align: left" onclick="otvet(this)" >
              <span class="text mr-4">A: </span>
            </button>

            <button id="2" type="button" class="btn btn-outline-dark mr-4 mi1" style ="text-align: left" onclick="otvet(this)" >
              <span class="text mr-4">B: </span>
            </button> 
      ...
      <div class="col-md-6 col-xl-3 b3">
        <div class="container-fluid">
          <div>
            ...
            <button id="3" type="button" class="btn btn-outline-dark mb-4 ml-5 mi1" style ="text-align: left" onclick="otvet(this)" >
              <span class="text mr-4">C: </span>
            </button>

            <button id="4" type="button" class="btn btn-outline-dark ml-5 mi1" style ="text-align: left" onclick="otvet(this)" >
              <span class="text mr-4">D: </span>
            </button> 
