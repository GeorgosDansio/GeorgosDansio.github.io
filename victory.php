...
<?php
  ...
  $sql = "SELECT * FROM `vopros_2` WHERE `vopros_id` =" . $x;
...
?>     
      ...
      <div class="col-md-6 col-xl-4 a2 justify-content-center">
        <div id="rectangle4">
          <h3 style = "text-align: center;color: #007bff">Поздавляем!!!!!</h3>
          <h4 style = "text-align: center;color: #007bff">Вы стали победителем!!!</h4>
          <pre></pre>
          <pre></pre>
          <pre></pre>
          <p style = "text-align: center;">Заработанные баллы: <?php if (isset($_COOKIE['reiting'])){echo $_COOKIE['reiting'];} else {echo 0;} ?></p>
          <p style = "text-align: center;">Ваш результат записан в рейтинг лучших!</p>
        </div>
